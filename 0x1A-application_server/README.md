...
mandatory
Let’s serve what you built for AirBnB clone v3 - RESTful API [https://intranet.alxswe.com/projects/311#task-3920] on web-01.
...
mandatory
Let’s serve what you built for AirBnB clone - Web dynamic [https://intranet.alxswe.com/projects/311#task-3920] on web-01.
...
#advanced
One of the most important metrics for any Internet-based business is its uptime. It is the percentage of the time over a given period that the service/product is accessible to customers. Let’s pick the example of Amazon.com, for every minute of downtime (which is the opposite of uptime), it costs the company $2M [https://intranet.alxswe.com/projects/311#task-3920]. Yet, application servers often need to restart to update with the new version of the code or new configuration, when doing this operation, an application server cannot serve traffic, which meant downtime.
